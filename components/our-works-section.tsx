    ...
    <section id="our-works" className="py-20 bg-white">
      <div className="container mx-auto px-6">
        ...
        <div className="flex justify-start mb-10">
          ...
          >
            <span className="font-medium">See All Our Works</span>
          ...
          {projects.map((project) => (
            <div key={project.id} className="bg-black rounded-lg overflow-hidden">
              <div className="relative h-44">
                <Image src="/project-image.png" alt={`${project.client} project`} fill className="object-cover" />
              </div>
              <div className="p-4">
                ...
                <p className="text-white text-xs leading-tight">{project.description}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="flex justify-center">
          <Button className="bg-[#1A2238] text-white hover:bg-[#2a3756]">Let&apos;s Talk Impact</Button>
        </div>
      </div>
    </section>
  )
